...
class CogVideoXTransformer3DModel(ModelMixin, ConfigMixin):
    ...
    def from_pretrained(
        ...
        if patch_embed_key not in state_dict:
            print(f"{patch_embed_key} missing in base transformer state_dict; skipping base weight adaptation.")
        elif model.state_dict()[patch_embed_key].size() != state_dict[patch_embed_key].size():
